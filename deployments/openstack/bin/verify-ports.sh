...
rules=$(openstack security group rule list --os-cloud  $CLOUD_NAME --format json $security_group_name | jq -c '.[] | {port_range: .["Port Range"], ip_protocol: .["IP Protocol"], remote_group: .["Remote >
